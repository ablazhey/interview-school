...
class SectionsTest < ApplicationSystemTestCase
  ...
  test "creating a Section" do
    ...
    fill_in "Class room", with: @section.class_room
    fill_in "From", with: @section.from
    fill_in "Teacher subject", with: @section.teacher_subject_id
    fill_in "To", with: @section.to
