...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { section: @schedule.section, student_id: @schedule.student_id } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { section: @schedule.section, student_id: @schedule.student_id } }
